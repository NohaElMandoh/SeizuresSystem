        ...
        <div class="row align-items-end ">
            ...
            <div class="col-lg-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item "><a href="#">إضافة تاجر </a></li>
...
<div class="jumbotron shade pt-5">
    ...
    <div class="row ">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
            ...
            <h4 class="c-grey  pt-3 pb-3">إضافة تاجر</h4>
            <hr class="mt-0 mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-row align-items-center">
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control " name='name' id="name" require placeholder="اسم التاجر ">
                            </div>
                            <div class="col-4">
                                <label for="unique_id"> رقم هوية التاجر *</label>
                                <input type="number" class="form-control " name='unique_id' id="unique_id" require placeholder="رقم هوية التاجر ">
                            </div>
                            <div class="col-4">
                                <label for="operator_id"> رقم مشغل *</label>
                                <input type="text" class="form-control " name='operator_id' id="operator_id" require placeholder="رقم مشغل ">
                            </div>
                        </div>
                        <div class="form-row align-items-center ">
                            <div class="col-4 ">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control " name='mobile' id="mobile" require placeholder="الهاتف  ">
                        ...
                        <div class="form-row align-items-center ">
                            <div class="col-8 ">
                                ...
                                <input type="text" class="form-control " name='address' id="address" require placeholder="العنوان  ">
