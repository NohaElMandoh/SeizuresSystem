        ...
        <div class="row align-items-end ">
            ...
            <div class="col-lg-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item "><a href="#">إضافة مستخدم </a></li>
...
<div class="jumbotron shade pt-5">
    ...
    <div class="row ">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
            ...
            <h4 class="c-grey  pt-3 pb-3">إضافة مستخدم</h4>
            <hr class="mt-0 mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-row align-items-center">
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control " name='name' id="name" require placeholder="اسم المستخدم ">
                            </div>
                            <div class="col-4">
                                <label for="email"> البريد الاليكترونى *</label>
                                <input type="Email" class="form-control " name='email' id="email" require placeholder="البريد الاليكترونى   ">
                            </div>
                            <div class="col-4">
                                <label for="phone"> رقم الهاتف *</label>
                                <input type="text" class="form-control " name='phone' id="phone" require placeholder="رقم الهاتف ">
                            </div>
                            <div class="col-4 ">
                            ...
                            <div class="col-4 ">
                                ...
                                <select class="form-select form-control" id="role_id" name="role_id">
                                    ...
                                    <option value="2"> مدير فرع</option>
