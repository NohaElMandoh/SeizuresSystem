...
<div class="jumbotron shade pt-5">
    ...
    <div class="row ">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
            ...
            <h4 class="c-grey  pt-3 pb-3">إضافة غرامة</h4>
            <hr class="mt-0 mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-row align-items-center">
                            <div class="col-4">
                                ...
                                <input type="number" class="form-control " name='bailiff_number' id="bailiff_number" require placeholder="رقم وصل الغرامة   ">
                            </div>
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" step="0.01" class="form-control " name='price' id="price" require placeholder="المبلغ    ">
                            </div>
                        </div>
                        @if($merchant)
                        <div class="form-row align-items-center">
